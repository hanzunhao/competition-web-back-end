...
@Component
@Slf4j
public class FlowerPotSocketHandler extends AbstractWebSocketHandler {
    @Override
    ...
    public void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
        ...
        try{
            ...
            FlowerPot flowerPot = mapper.readValue(payload, FlowerPot.class);
            log.info("反序列化：" + flowerPot);
